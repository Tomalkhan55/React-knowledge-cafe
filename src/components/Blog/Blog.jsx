...
const Blog = ({ blog, handleAddToBookmark, handleMarkAsRead }) => {
    const { id, title, cover, author_img, author, date, reading_time, hashtags } = blog;
    return (
        <div className='my-5'>
            ...
            <button onClick={() => handleMarkAsRead(id,reading_time)} className='text-blue-500 font-medium underline'>Mark as read</button>
        </div>
    );
};
